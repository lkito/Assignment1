...
public class TabooTest {
    ...
    public void tabooTest3(){
        List<Integer> rule = Arrays.asList(2, 2, 2, 2, null, 2, 2, 2);
        Taboo<Integer> tab = new Taboo<>(rule);
        tab.reduce(rule);
        assertEquals(Arrays.asList(2), rule);

        List<Integer> test = Arrays.asList(1, 2, 5, null, 10, 5);
        tab.reduce(test);
        assertEquals(Arrays.asList(1, 2, 5, null, 10, 5), test);
        test = Arrays.asList();
        tab.reduce(test);
    ...
    public void tabooTest4(){
        ...
        List<Integer> test = Arrays.asList(534, 1000, 1000, 1000, 22, 534, 2000, 10, 10, 2000);
        tab.reduce(test);
    ...
    public void tabooTest5(){
        ...
        List<Integer> test = Arrays.asList(1, 2, 4, 5, 6, 2, 9, 8, 7, 8, 3, 3, 3, 2);
        tab.reduce(test);
    ...
    public void tabooTest6(){
        ...
        List<String> test = Arrays.asList("bla", "bla", "blu", "bli", "bla", "blo",
    ...
    public void tabooTest7(){
        ...
        List<Character> test = Arrays.asList('A', 'a', 'a', 'a', 'a', 'B', 'b', 'b', 'b',
                'A', 'a', 'a', 'R', 'A', 'a', '!');
        tab.reduce(test);
